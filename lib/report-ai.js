...
async function generateSwot(data, KEY, MODELS) {
    ...
    return { symbol: String(data.symbol || '').toUpperCase(), swot: parsed.swot, strategy: parsed.strategy || {}, risks: parsed.risks || {}, declineExplanations: Array.isArray(parsed.declineExplanations) ? parsed.declineExplanations : [] };
}
