...
החזר אך ורק אובייקט JSON תקין (ללא טקסט נוסף, ללא markdown, ללא \`\`\`) במבנה המדויק הבא:
{
  "summary": {
    ...
    "investments": "ההשקעות המרכזיות של החברה. אם סופק נתון הוצאות מו\\"פ (rdExpenseTTM) — ציין אותו, ופרט באופן ספציפי מה החברה מפתחת באותו מו\\"פ (אילו טכנולוגיות, מוצרים, ארכיטקטורות או קווי-מוצר קונקרטיים), על בסיס ידע ציבורי על החברה — לא ניסוח גנרי. כלול גם CapEx/רכישות/הרחבות מהותיות אם רלוונטי.",
    "keyCustomers": "הלקוחות, הסגמנטים או השווקים הגאוגרפיים המרכזיים של החברה — שמות ספציפיים כשידועים.",
    "recentDeals": "חוזים, הזמנות, שותפויות או עסקאות גדולות וספציפיות שהחברה סגרה לאחרונה (על בסיס ידע ציבורי) — ציין שמות ומהות. אל תכתוב 'לא ידוע' אם קיים מידע ציבורי רלוונטי; רק אם באמת אין — ציין זאת בקצרה.",
    "insiderActivity": "אם סופקו נתוני עסקאות בעלי עניין (recentInsiderTrades) — סכם אותם בקצרה בעברית, בדגש על קניות מהותיות של מנהלים/דירקטורים (מי, מתי, היקף משוער), וציין אם המגמה היא קנייה או מכירה. אם לא סופקו נתונים — ציין שאין מידע זמין על עסקאות בעלי עניין מהותיות לאחרונה."
  },
  "swot": {
