...
החזר אך ורק אובייקט JSON תקין (ללא טקסט נוסף, ללא markdown, ללא \`\`\`) במבנה המדויק הבא:
{
  "summary": {
    ...
    "insiderActivity": "עסקאות בעלי עניין — חובה לספק נתונים עם תאריך לכל עסקה. אם סופקו נתוני recentInsiderTrades — סכם אותם וכלול את התאריך המדויק של כל עסקה (כפי שמופיע), בדגש על קניות מהותיות (מי, תאריך, היקף משוער) וציין אם המגמה קנייה או מכירה. אם לא סופקו נתונים — ספק מהידע הציבורי שלך עסקאות בעלי-עניין בולטות מהשנה האחרונה (עד 12 חודשים אחורה) עם תאריך משוער (חודש/שנה), שם בעל העניין והיקף. תמיד החזר התייחסות עם תאריך — אל תכתוב 'לא סופקו נתונים'; אם באמת אין שום מידע ידוע על החברה, ציין מתי בוצעו לאחרונה דיווחי Form 4 אופייניים לחברה זו."
  },
  "swot": {
