...
// The "קפל חדשות" header button was retired (it folded away the page's only content —
// no value). The feed is always shown; the persisted fold flag is cleared so anyone who
// left it collapsed isn't stuck with a permanently hidden feed and no button to reopen it.
try { localStorage.removeItem('dn_feed_collapsed'); } catch (e) { }
// Kept as a no-op: older cached markup may still reference the onclick handler.
